...
var EXPSTR = container_mc.mExpGroup.text_exp.text;
var expTextFieldStartX = container_mc.mExpGroup.text_exp._x + container_mc.mExpGroup.text_exp._width;
...
function PaperDoll_Visible(bool)
{
   ...
   container_mc.mExpGroup._visible = bool;
   ...
   if(tab2.activedNum == 1)
   {
      container_mc.mExpGroup._visible = true;
...
myListener.OnGameEventShowWindow = function(widgetName, bShow)
{
   if(widgetName.toLowerCase() == UIname.toLowerCase() && (isTheOther == undefined || isTheOther == 0))
   {
      ...
      isTheOther = false;
      container_mc.mBGModule.gotoAndStop(1);
   ...
   else if(widgetName.toLowerCase() == UIname2.toLowerCase() && (isTheOther == undefined || isTheOther == 1))
   {
      ...
      isTheOther = true;
      container_mc.mBGModule.gotoAndStop(2);
      UI._visible = _global.gbUIMode && bShow;
   }
   if(UI._visible == true)
   {
...
myListener.OnGameEventUpdateUserExp = function(cexp, maxexp, _theOther, percent)
{
   ...
   container_mc.mExpGroup.text_exp.text = _loc3_ + " / " + " (" + percent + "%)" + _loc2_;
   lib.manager.ToolTip.remove(container_mc.mExpGroup);
   lib.manager.ToolTip.add(container_mc.mExpGroup,"<font color=\'#73EEF7\'>" + _loc3_ + "</font> / " + _loc2_ + " (" + percent + "%)",1);
   if(container_mc.mExpGroup.text_exp.textWidth > 250)
   {
      var _loc4_ = container_mc.mExpGroup.text_exp.getCharIndexAtPoint(256,10);
      var _loc5_ = container_mc.mExpGroup.text_exp.text.substr(0,_loc4_) + "...";
      var _loc6_ = _loc5_.split("%)");
      _loc2_ = _loc6_[1];
   }
   container_mc.mExpGroup.text_exp.htmlText = "<font color=\'#73EEF7\'>" + _loc3_ + "</font> / " + _loc2_ + " (" + percent + "%)";
   container_mc.mExpGroup.text_exp._width = container_mc.mExpGroup.text_exp.textWidth + 5;
   container_mc.mExpGroup.text_exp._x = expTextFieldStartX - container_mc.mExpGroup.text_exp._width;
   container_mc.mExpGroup.expIconMc._x = container_mc.mExpGroup.text_exp._x - container_mc.mExpGroup.expIconMc._width;
};
...
myListener.OnGameEvent_PaperDoll_SetSilhouette = function(sex, race, _theOther)
{
   ...
   var _loc2_ = flash.display.BitmapData.loadBitmap("img://__S1UIRES_Skin.PaperDoll_" + race + "_" + sex);
   ...
   {
      _loc1_.redMultiplier = 0.3;
      _loc1_.greenMultiplier = 0.3;
      _loc1_.blueMultiplier = 0.3;
   }
   container_mc.uiBgMc2.transform.colorTransform = _loc1_;
};
...
myListener.OnGame_PaperDoll_InstanceDungeon = function(id, __name, timeStr, _theOther)
{
   ...
   var _loc2_ = _loc3_["line" + indunCount];
   if(_loc2_ == undefined)
   {
   ...
   var _loc4_ = container_mc.scrollbar.scroll;
   container_mc.scrollbar.pageSize = container_mc.indunContainer._height;
   container_mc.scrollbar.scroll = _loc4_;
};
