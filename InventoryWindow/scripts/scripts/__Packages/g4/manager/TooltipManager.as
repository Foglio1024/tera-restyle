class g4.manager.TooltipManager
{
   ...
   function addItemTooltip(mc_target, itemId)
   {
      if(mc_target instanceof g4.core.G4UIComponent)
      {
         (g4.core.G4UIComponent)mc_target.addEventListener(gfx.events.EventTypes.ROLL_OVER,this,g4.util.Delegate.create(this,this.showItemTooltip,mc_target,itemId));
         (g4.core.G4UIComponent)mc_target.addEventListener(gfx.events.EventTypes.DISABLED_ROLL_OVER,this,g4.util.Delegate.create(this,this.showItemTooltip,mc_target,itemId));
         (g4.core.G4UIComponent)mc_target.addEventListener(gfx.events.EventTypes.ROLL_OUT,this,this.hideTooltip);
         (g4.core.G4UIComponent)mc_target.addEventListener(gfx.events.EventTypes.DISABLED_ROLL_OUT,this,this.hideTooltip);
         (g4.core.G4UIComponent)mc_target.addEventListener(gfx.events.EventTypes.DRAG_OUT,this,this.hideTooltip);
      }
      ...
      {
         mc_target.onRollOver = g4.util.Delegate.create(this,this.showItemTooltip,mc_target,itemId);
         mc_target.onRollOut = g4.util.Delegate.create(this,this.hideTooltip);
         mc_target.onDragOut = g4.util.Delegate.create(this,this.hideTooltip);
      }
   }
   ...
   function showItemTooltip(mc_target, itemId)
   {
      this._tooltipmodule.showItemTooltip(mc_target,itemId);
   }
   function hideTooltip(mc_target)
   {
      this._tooltipmodule.hideTooltip(mc_target);
   }
}
