class g4.view.baseUI.BaseUI
{
   ...
   function BaseUI(targetMovieClip)
   {
      ...
      new g4.view.baseUI.BaseUI_Announce();
      ...
      _global.StartIconDrag = function(slot, IconName, x, y, xo, yo)
      {
         ...
         if(IconName != "")
         {
            ...
            scope.gbDraggedIcon = scope.CreateDraggedIcon(slot,IconName);
            Mouse.hide();
      ...
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_PARTYWINDOW_BOOLEAN] = g4.view.ViewID.PARTY_WINDOW;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_PARTYWINDOWRAIDINFO_BOOLEAN] = g4.view.ViewID.PARTY_WINDOW_RAID_INFO;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_MINIMAP_BOOLEAN] = g4.view.ViewID.MINI_MAP;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_QUESTTASKINFO_BOOLEAN] = g4.view.ViewID.QUEST_TASK_INFO;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_MAINMENU_BOOLEAN] = g4.view.ViewID.MAIN_MENU;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_OVERLAY_BOOLEAN] = g4.view.ViewID.OVERLAY_MAP_2;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_CHAT_BOOLEAN] = g4.view.ViewID.CHAT_2;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_SHORTCUT_BOOLEAN] = g4.view.ViewID.SHORT_CUT;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_EXTSHORTCUT1_BOOLEAN] = "ExtShortCut";
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_EXTSHORTCUT2_BOOLEAN] = "ExtShortCut2";
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_ABNORMALITY_BOOLEAN] = g4.view.ViewID.ABNORMALITY;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_PREMIUMSLOT_BOOLEAN] = g4.view.ViewID.PREMIUM_SLOT_PANEL;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_BENEFIT_BOOLEAN] = g4.view.ViewID.BENEFIT;
      this.battleModeObj[lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_CHARACTERWINDOW_BOOLEAN] = g4.view.ViewID.CHARACTER_WINDOW;
      ...
      g4.manager.SimplePopupManager.getInstance().init(this._container_simplePopup_mc);
   }
   function createContainers()
   {
      this._container_question_mc = this._targetMovieClip.createEmptyMovieClip("container_question_mc",0);
      this._container_overlayMap_mc = this._targetMovieClip.createEmptyMovieClip("container_overlayMap_mc",1);
      this._container_balloon_mc = this._targetMovieClip.createEmptyMovieClip("container_balloon_mc",2);
      this._container_chat_mc = this._targetMovieClip.createEmptyMovieClip("container_chat_mc",3);
      this._container_message_mc = this._targetMovieClip.createEmptyMovieClip("container_message_mc",4);
      this._container_battle_mc = this._targetMovieClip.createEmptyMovieClip("container_battle_mc",5);
      this._container_lobby_mc = this._targetMovieClip.createEmptyMovieClip("container_lobby_mc",6);
      this._container_normal_mc = this._targetMovieClip.createEmptyMovieClip("container_normal_mc",7);
      this._container_battleUp_mc = this._targetMovieClip.createEmptyMovieClip("container_battleUp_mc",8);
      this._container_villager_mc = this._targetMovieClip.createEmptyMovieClip("container_villager_mc",9);
      this._container_halfPopup_mc = this._targetMovieClip.createEmptyMovieClip("container_halfPopup_mc",10);
      this._container_mainmenu_mc = this._targetMovieClip.createEmptyMovieClip("container_mainmenu_mc",11);
      this._container_mainmenuUpside_mc = this._targetMovieClip.createEmptyMovieClip("container_mainmenuUpside_mc",12);
      this._container_norPopup_mc = this._targetMovieClip.createEmptyMovieClip("container_norPopup_mc",13);
      this._container_interPopup_mc = this._targetMovieClip.createEmptyMovieClip("container_interPopup_mc",14);
      this._container_inGameMovie_mc = this._targetMovieClip.createEmptyMovieClip("container_inGameMovie_mc",15);
      this._container_highDepth_mc = this._targetMovieClip.createEmptyMovieClip("container_highDepth_mc",16);
      this._container_alwaysVisible_mc = this._targetMovieClip.createEmptyMovieClip("container_alwaysVisible_mc",17);
      this._container_sysPopup_mc = this._targetMovieClip.createEmptyMovieClip("container_sysPopup_mc",18);
      this._container_simplePopup_mc = this._targetMovieClip.createEmptyMovieClip("container_simplePopup_mc",19);
      this._container_tooltip_mc = this._targetMovieClip.createEmptyMovieClip("container_tooltip_mc",20);
      this._container_logout_mc = this._targetMovieClip.createEmptyMovieClip("container_logout_mc",21);
   }
   ...
   function OnGame_DisableUI(Name, bTrue)
   {
      ...
      {
         this.setDisableUI(this._container_normal_mc,bTrue);
      }
      else if(Name == "CONTAINER_BATTLE")
      {
         this.setDisableUI(this._container_battle_mc,bTrue);
         this.setDisableUI(this._container_overlayMap_mc,bTrue);
         this.setDisableUI(this._container_chat_mc,bTrue);
      }
      else if(Name == "CONTAINER_BATTLEUP")
      {
         this.setDisableUI(this._container_battleUp_mc,bTrue);
      }
      else if(Name == "CONTAINER_HALFPOPUP")
      {
         this.setDisableUI(this._container_halfPopup_mc,bTrue);
      }
      ...
      {
         this.setDisableUI(this._container_norPopup_mc,bTrue);
      }
      else if(Name == "CONTAINER_POPUP_INTERACTION")
      {
         this.setDisableUI(this._container_interPopup_mc,bTrue);
      }
      else if(Name == "CONTAINER_POPUP_SYSTEM")
      {
         this.setDisableUI(this._container_sysPopup_mc,bTrue);
      }
      else if(Name == "CONTAINER_LOBBY")
      {
         this.setDisableUI(this._container_lobby_mc,bTrue);
      }
      else if(Name == "CONTAINER_MAINMENUUPSIDE")
      {
         this.setDisableUI(this._container_mainmenuUpside_mc,bTrue);
      }
      else if(Name == "CONTAINER_TOOLTIP")
      {
         this.setDisableUI(this._container_tooltip_mc,bTrue);
      }
      else
      {
   ...
   {
      this.bTelePorting = false;
      this._container_sysPopup_mc._visible = true;
      this._container_logout_mc._visible = true;
      this._container_interPopup_mc._visible = true;
      this._container_norPopup_mc._visible = true;
      this._container_tooltip_mc._visible = true;
      this._container_mainmenu_mc._visible = true;
      this._container_question_mc._visible = true;
      this._container_villager_mc._visible = true;
      this._container_battleUp_mc._visible = true;
      var _loc3_ = 0;
      ...
      this._container_battle_mc._visible = true;
      this._container_overlayMap_mc._visible = true;
      this._container_chat_mc._visible = true;
      this._container_balloon_mc._visible = true;
      this._container_halfPopup_mc._visible = true;
      this._container_inGameMovie_mc._visible = true;
      this._container_lobby_mc._visible = true;
      this._container_mainmenuUpside_mc._visible = true;
   }
   function OnGame_StartTelePort()
   {
      this.bTelePorting = true;
      _root.OnGameEvent("OnGame_CantHideMsg_ShowLogo",false);
      this._container_sysPopup_mc._visible = false;
      this._container_logout_mc._visible = false;
      this._container_interPopup_mc._visible = false;
      this._container_norPopup_mc._visible = false;
      this._container_tooltip_mc._visible = false;
      this._container_mainmenu_mc._visible = false;
      this._container_question_mc._visible = false;
      this._container_villager_mc._visible = false;
      for(var _loc4_ in this._container_normal_mc)
      {
         var _loc3_ = this._container_normal_mc[_loc4_];
      ...
      for(var _loc4_ in this._container_battle_mc)
      {
         _loc3_ = this._container_battle_mc[_loc4_];
         if(typeof _loc3_ == "movieclip")
         {
      ...
      this._container_overlayMap_mc._visible = false;
      this._container_chat_mc._visible = false;
      this._container_balloon_mc._visible = false;
      this._container_halfPopup_mc._visible = false;
      this._container_inGameMovie_mc._visible = false;
      this._container_lobby_mc._visible = false;
      this._container_mainmenuUpside_mc._visible = false;
      for(var _loc4_ in this._container_battleUp_mc)
      {
         _loc3_ = this._container_battleUp_mc[_loc4_];
         if(typeof _loc3_ == "movieclip")
         {
   ...
   {
      bHide = Number(bHide);
      this._container_sysPopup_mc._visible = !bHide;
      this._container_logout_mc._visible = !bHide;
      this._container_interPopup_mc._visible = !bHide;
      this._container_norPopup_mc._visible = !bHide;
      this._container_tooltip_mc._visible = !bHide;
      this._container_mainmenu_mc._visible = !bHide;
      this._container_question_mc._visible = !bHide;
      this._container_villager_mc._visible = !bHide;
      this._container_battleUp_mc._visible = !bHide;
      this._container_normal_mc._visible = !bHide;
      this._container_battle_mc._visible = !bHide;
      this._container_overlayMap_mc._visible = !bHide;
      this._container_chat_mc._visible = !bHide;
      this._container_halfPopup_mc._visible = !bHide;
      this._container_message_mc._visible = true;
      this._container_inGameMovie_mc._visible = !bHide;
      this._container_lobby_mc._visible = !bHide;
      this._container_mainmenuUpside_mc._visible = !bHide;
      this._container_highDepth_mc._visible = !bHide;
   }
   function OnGame_HideAllUI(bHide)
   {
      ...
      this._container_chat_mc._visible = !bHide;
      this._container_halfPopup_mc._visible = !bHide;
      this._container_message_mc._visible = !bHide;
      this._container_inGameMovie_mc._visible = !bHide;
      this._container_lobby_mc._visible = !bHide;
      this._container_mainmenuUpside_mc._visible = !bHide;
      this._container_highDepth_mc._visible = !bHide;
   ...
   {
      Debug.log("g4.view.baseUI.BaseUI.OnGameEventChangeUIMode > bMode : " + bMode);
      bMode = Number(bMode);
      _global.gbUIMode = bMode == true || bMode == 1 || bMode == "1";
      if(bMode == 0)
      {
   ...
   {
      var _loc4_ = [g4.view.ViewID.GAME_STAT,"CharacterWindow","SkillHotKey","ShortCut","ExtShortCut","ExtShortCut2","Abnormality","TargetInfo","GageBar","GageBoss","GageBossTeamA","GageBossTeamB","Crosshair","Message","DungeonEventGage","CoolTimeAlim2","GageStackBar","Balloon","Debuger"];
      ...
      if(bMode)
      {
         ...
         while(_loc5_ < _loc9_)
         {
            ...
            if(this.changedVisibleUINameObj[_loc7_] == undefined)
            {
               if(_loc3_ && _loc6_)
               {
                  if(_loc3_.bWidgetOpen == undefined && _loc3_.bWindowOpen == undefined)
                  {
   ...
   function changedUICustomizeHandler(event)
   {
      switch(event.key)
      {
         ...
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_UI_BOOLEAN:
            ...
            if(this.bUsedBattleMode == false && _global.gbBattleMode)
            {
         ...
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_SHORTCUT_BOOLEAN:
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_EXTSHORTCUT1_BOOLEAN:
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_EXTSHORTCUT2_BOOLEAN:
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_ABNORMALITY_BOOLEAN:
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_PREMIUMSLOT_BOOLEAN:
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_BENEFIT_BOOLEAN:
         case lib.gamedata.CustomizedUIDataKey.BATTLEMODE_VISIBLE_CHARACTERWINDOW_BOOLEAN:
      ...
      if(_loc12_ != 61)
      {
         ...
         else if(_loc12_ != 58 && _loc4_ != "expbar" && _loc4_ != "awesomeframe" && _loc4_ != "playguide" && _loc4_ != "attendevent")
         {
            for(var _loc11_ in win)
            {
               ...
               if(typeof _loc2_ == "movieclip" && _loc2_ != win && _loc2_ != this._container_chat_mc.Chat2 && win != _loc8_ && win != _loc7_)
               {
   ...
   function LoadUI(Name, Path, bAlwaysLoaded, group, ifLogOutClose, expandOption)
   {
      ...
      var _loc10_ = this.GetRegisterUIData(Name);
      var _loc3_ = Name.toLowerCase();
      switch(group)
      {
         case 1:
            _loc2_ = this._container_normal_mc;
            break;
         case 2:
            _loc2_ = this._container_battle_mc;
            break;
         case 3:
            _loc2_ = this._container_normal_mc;
            break;
         case 10:
            _loc2_ = this._container_battleUp_mc;
            break;
         case 11:
            _loc2_ = this._container_logout_mc;
            break;
         case 12:
            _loc2_ = this._container_overlayMap_mc;
            break;
         case 13:
            _loc2_ = this._container_halfPopup_mc;
            break;
         case 14:
            _loc2_ = this._container_mainmenuUpside_mc;
            break;
         case 40:
            _loc2_ = this._container_alwaysVisible_mc;
            break;
         case 49:
            _loc2_ = this._container_highDepth_mc;
            break;
         case 50:
            _loc2_ = this._container_balloon_mc;
            break;
         case 51:
            _loc2_ = this._container_sysPopup_mc;
            break;
         case 52:
            _loc2_ = this._container_interPopup_mc;
            break;
         case 53:
            _loc2_ = this._container_norPopup_mc;
            break;
         case 54:
            _loc2_ = this._container_question_mc;
            break;
         case 55:
            _loc2_ = this._container_tooltip_mc;
            break;
         case 56:
            _loc2_ = this._container_chat_mc;
            break;
         case 58:
            _loc2_ = this._container_inGameMovie_mc;
            break;
         case 59:
            _loc2_ = this._container_message_mc;
            break;
         case 60:
            _loc2_ = this._container_battle_mc;
            break;
         case 61:
            _loc2_ = this._container_lobby_mc;
            break;
         case 48:
            _loc2_ = this._container_mainmenu_mc;
            break;
         default:
            _loc2_ = this._container_battle_mc;
      }
      _loc2_.gDepth = _loc2_.getNextHighestDepth();
      _loc5_ = _loc2_.createEmptyMovieClip(Name,_loc2_.gDepth);
      var _loc8_ = new MovieClipLoader();
      this.waitingShowUI[_loc3_] = {lstate:true,expandOption:undefined};
      var _loc7_ = new Object();
      _loc7_.onLoadInit = g4.util.Delegate.create(this,this.OnLoadInit,_loc10_,_loc3_,group,bAlwaysLoaded,expandOption,_loc5_);
      _loc8_.addListener(_loc7_);
      _loc8_.loadClip(Path,_loc5_);
      Debug.log("g4.view.baseUI.BaseUI.LoadUI > Name : " + Name + ", Path : " + Path + ", bAlwaysLoaded : " + bAlwaysLoaded + ", group : " + group + ", ifLogOutClose : " + ifLogOutClose + ", expandOption : " + expandOption);
   }
   function OnLoadInit(UIdata, Name, group, bAlwaysLoaded, expandOption, makeUI, target)
   {
      Debug.log("g4.view.baseUI.BaseUI.OnLoadInit > UIdata : " + UIdata + ", Name : " + Name + ", group : " + group + ", bAlwaysLoaded : " + bAlwaysLoaded + ", expandOption : " + expandOption + ", makeUI : " + makeUI + ", target : " + target);
      var _loc3_ = Name.toLowerCase();
      target.info = UIdata;
      ...
      if(target._parent == this._container_normal_mc || target._parent == this._container_battleUp_mc)
      {
         var _loc8_ = this._container_normal_mc.getDepth();
         var _loc7_ = this._container_battleUp_mc.getDepth();
   ...
   function ShowUI(Name, expandOption)
   {
      ...
      if(_loc3_._visible != true)
      {
         ...
         else
         {
            ...
            if(_loc3_._parent == this._container_normal_mc || _loc3_._parent == this._container_battleUp_mc)
            {
               var _loc7_ = this._container_normal_mc.getDepth();
               var _loc6_ = this._container_battleUp_mc.getDepth();
   ...
   {
      for(var _loc3_ in this._container_normal_mc)
      {
         if(typeof this._container_normal_mc[_loc3_] == "movieclip")
         {
            var _loc2_ = this._container_normal_mc[_loc3_];
      ...
      for(var _loc3_ in this._container_battle_mc)
      {
         if(typeof this._container_battle_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_battle_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
      ...
      for(var _loc3_ in this._container_battleUp_mc)
      {
         if(typeof this._container_battleUp_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_battleUp_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
      ...
      for(var _loc3_ in this._container_overlayMap_mc)
      {
         if(typeof this._container_overlayMap_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_overlayMap_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
      ...
      for(var _loc3_ in this._container_chat_mc)
      {
         if(typeof this._container_chat_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_chat_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
      ...
      for(var _loc3_ in this._container_halfPopup_mc)
      {
         if(typeof this._container_halfPopup_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_halfPopup_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
      ...
      for(var _loc3_ in this._container_mainmenu_mc)
      {
         if(typeof this._container_mainmenu_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_mainmenu_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
      ...
      for(var _loc3_ in this._container_mainmenuUpside_mc)
      {
         if(typeof this._container_mainmenuUpside_mc[_loc3_] == "movieclip")
         {
            _loc2_ = this._container_mainmenuUpside_mc[_loc3_];
            if(this.GetRegisterUIData(_loc2_._name).locked || this.GetRegisterUIData(_loc2_._name).GROUP != 1)
            {
               this.ToGame_RequestSetUIPosition(_loc2_._name);
            }
   ...
   function CreateDraggedIcon(slot, iconPath)
   {
      this.dragSlot_mc._visible = true;
      this.dragSlot_mc.swapDepths(_root.getNextHighestDepth());
      this.dragSlot_mc.draw(iconPath,40,40);
   ...
   {
      g4.model.GameInterface.callGameInterface("ToGameStartDrag",slotName);
   }
   function ToGameEndDrag(slotName)
   {
      g4.model.GameInterface.callGameInterface("toGameEndDrag",slotName);
   }
