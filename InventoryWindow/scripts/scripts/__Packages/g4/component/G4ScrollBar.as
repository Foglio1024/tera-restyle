class g4.component.G4ScrollBar extends gfx.controls.ScrollIndicator
{
   var trackScrollPageSize = 1;
   var _trackMode = "scrollPage";
   var trackScrollPosition = -1;
   function G4ScrollBar()
   {
      super();
   }
   ...
   function toString()
   {
      return "[Scaleform G4ScrollBar " + this._name + "]";
   }
   function configUI()
   {
      if(this.bindingEnabled)
      {
         flash.external.ExternalInterface.call("__registerControl",this._name,this,"G4ScrollBar");
         this.addEventListener("scroll",this,"dispatchEventToGame");
      ...
      {
         this.downArrow = new g4.component.G4Button();
      }
      if(this.upArrow == null)
      {
         this.upArrow = new g4.component.G4Button();
      }
      this.upArrow.addEventListener(gfx.events.EventTypes.CLICK,this,this.scrollUp);
      this.downArrow.addEventListener(gfx.events.EventTypes.CLICK,this,this.scrollDown);
      this.thumb.addEventListener(gfx.events.EventTypes.PRESS,this,this.beginDrag);
      this.track.addEventListener(gfx.events.EventTypes.PRESS,this,this.beginTrackScroll);
      this.track.addEventListener(gfx.events.EventTypes.CLICK,this,this.trackScroll);
   ...
   function beginTrackScroll(button, mouseIndex)
   {
      ...
      if(Key.isDown(16) || this.__get__trackMode() == "scrollToCursor")
      {
         ...
         this.trackDragMouseIndex = mouseIndex;
