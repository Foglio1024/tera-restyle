class g4.component.G4Button extends g4.core.G4UIComponent
{
   ...
   {
      this.dispatchEvent(gfx.events.EventTypes.DISABLED_ROLL_OVER,[this,mouseIndex]);
   ...
   {
      this.dispatchEvent(gfx.events.EventTypes.DISABLED_ROLL_OUT,[this,mouseIndex]);
      if(this.useHandCursor == false)
      {
         return undefined;
      }
   ...
   function handleMousePress(mouseIndex, button)
   {
      ...
      this.setState("down");
      this.dispatchEvent(gfx.events.EventTypes.PRESS,[this,mouseIndex]);
      if(this.autoRepeat)
      {
   ...
   {
      this.dispatchEvent(gfx.events.EventTypes.DISABLED_CLICK,[this]);
      if(this.useHandCursor == false)
      {
         return undefined;
      }
      ...
      if(this.doubleClickEnabled)
      {
         ...
         else
         {
            ...
            this.dispatchEvent(gfx.events.EventTypes.DOUBLE_CLICK,[this,mouseIndex]);
   ...
   function handleDragOver(mouseIndex)
   {
      ...
      this.dispatchEvent(gfx.events.EventTypes.DRAG_OVER,[this,mouseIndex]);
   }
   function handleDragOut(mouseIndex)
   {
      ...
      this.dispatchEvent(gfx.events.EventTypes.DRAG_OUT,[this,mouseIndex]);
   }
   function handleReleaseOutside(mouseIndex, button)
   {
      ...
      this.dispatchEvent(gfx.events.EventTypes.RELEASE_OUTSIDE,[this,this.state,button]);
   }
   ...
   {
      var _loc2_ = (g4.component.ButtonGroup)value;
      if(typeof value == "string")
      {
         _loc2_ = this._parent["_buttonGroup_" + value];
         if(_loc2_ == null)
         {
            this._parent["_buttonGroup_" + value] = _loc2_ = new g4.component.ButtonGroup(value.toString(),this._parent);
         }
      }
   ...
   function __set__selected(value)
   {
      ...
      {
         this.dispatchEvent(gfx.events.EventTypes.SELECT,[this,this.__get__selected()]);
      }
   ...
   function updateAfterStateChange()
   {
      ...
      this.dispatchEvent(gfx.events.EventTypes.STATE_CHANGE,[this,this.state]);
   }
   ...
   {
      this.dispatchEvent(gfx.events.EventTypes.CLICK,[this,mouseIndex]);
   }
