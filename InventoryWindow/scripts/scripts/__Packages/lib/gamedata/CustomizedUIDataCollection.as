class lib.gamedata.CustomizedUIDataCollection extends lib.gamedata.GameDataCollectionImpl
{
   ...
   function createDefaultDatas()
   {
      ...
      this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.HPBAR_RIGHT_ALIGN_BOOLEAN,0));
      ...
      this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.MESSAGE_TIMESTAMP_VISIBLE,0));
