class g4.util.StringUtil
{
   ...
   static function getTimeString(originSeconds, isMillisecond)
   {
      var _loc1_ = -1;
      if(isMillisecond == true)
      {
         _loc1_ = Math.round(originSeconds % 1000 / 10);
         originSeconds = Math.ceil(originSeconds / 1000);
      }
      var _loc4_ = originSeconds % 60;
      var _loc5_ = Math.floor(originSeconds / 60) % 60;
      var _loc3_ = g4.util.StringUtil.addZeroNumber(_loc5_) + ":" + g4.util.StringUtil.addZeroNumber(_loc4_);
      if(_loc1_ != -1)
      {
         _loc3_ = _loc3_ + (":" + g4.util.StringUtil.addZeroNumber(_loc1_));
      }
      return _loc3_;
   }
}
