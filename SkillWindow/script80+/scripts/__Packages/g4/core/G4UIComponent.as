class g4.core.G4UIComponent extends MovieClip
{
   ...
   var _isConfigUIComplete = false;
   function G4UIComponent()
   {
      super();
      this._eventDispatcher = new g4.core.EventDispatcher();
   }
   ...
   {
      this._eventDispatcher.dispatchEvent(eventType,params);
   }
   function removeAllEventListener(scope)
   {
      this._eventDispatcher.removeAllEventListener(scope);
   }
   function onLoad()
   {
      this.onLoadImpl();
   ...
   function __set__visible(value)
   {
      ...
      this.dispatchEvent(_loc3_,[this]);
